...
import 'ja_google_2.dart';

void main() {
  runApp(const JGoogleSearch1());
}

class JGoogleSearch1 extends StatelessWidget {
  const JGoogleSearch1({super.key});
            ...
            children: <Widget>[
              ...
              TextButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (_) => const JGoogleSearch2()),
                  );
                },
                child: Text(
                  '次',
